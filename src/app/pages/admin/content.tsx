...
export function AdminContent() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-semibold text-gray-900 dark:text-gray-100">Edit Konten</h1>
                  ...
                  <div key={field.name} className="space-y-1.5">
                    ...
                    {field.type === 'textarea' ? (
                      <Textarea
                        ...
                        rows={4}
                        className="bg-white dark:bg-zinc-900 border-gray-200 dark:border-zinc-700 resize-none"
                      />
                    ) : (
                      <Input
                        id={field.name}
